...
Line2.prototype.growAdd = function(amount) {
  var v = this.getDirection()
  var np1 = this.p1.add(v.mult(amount))
  return L(this.p0, np1);
};

Line2.prototype.grow = function(factor) {
  var a = (this.p1.sub(this.p0)).mult(factor);
  var p1 = this.p0.add(a);
  return L(this.p0, p1);
};
