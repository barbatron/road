...
(function() {
  var Edge, Entity, Handle, Leaf, Lot, Node, k, makeRoad, root, splitRoad, v,
  ...
  root.loadAll = function() {
    ...
    find = function(obj, namespace) {
      ...
      for (k in obj) {
        ...
        if (((v != null ? v.___const : void 0) != null) && (root.classes[v.___const] != null) && v.___const !== "Object") {
        ...
        if (_.isObject(v)) {
          _results.push(find(v, namespace + "." + k));
        } else {
