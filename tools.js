...
(function() {
  var CommonTool, ContinousEdgeTool, EdgeTool, FreeEdgeTool, LeafTool, NodeTool, RoadTool, Tool, colorSpeed, root,
  ...
  ContinousEdgeTool = (function(_super) {
    __extends(ContinousEdgeTool, _super);

    function ContinousEdgeTool(handle) {
      this.handle = handle;
      ContinousEdgeTool.__super__.constructor.call(this);
    }

    ContinousEdgeTool.prototype.move = function(e) {};

    return ContinousEdgeTool;
