...
(function() {
  var CommonTool, EdgeTool, LeafTool, RoadTool, Tool, colorSpeed, root,
  ...
  EdgeTool = (function(_super) {
    ...
    function EdgeTool(handle) {
      ...
      if (((_ref = this.handle) != null ? _ref.edge : void 0) != null) {
        this.continous = false;
        this.handle = new ents.Handle(this.handle.node, this.handle.node);
      }
      this.endNode = null;
    }
